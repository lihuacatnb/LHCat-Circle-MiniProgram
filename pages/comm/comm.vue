            ...
            <view class="justify-content-item">
              <view class="tn-flex tn-flex-col-center tn-flex-row-left">
                ...
                <view class="tn-padding-right" style="width: 65vw;">
                  <view class="tn-padding-right tn-padding-left-sm tn-text-bold tn-text-lg">狸猫科技有限公司</view>
                </view>
        ...
        <view class="tn-flex-1 tn-margin-sm tn-radius" @click="navEdit">
          <view class="tn-flex tn-flex-direction-column tn-flex-row-center tn-flex-col-center">
            ...
            <view class="tn-color-white tn-text-sm tn-text-center">
              <text class="tn-text-ellipsis">发布帖子</text>
            </view>
          </view>
        </view>
  ...
  export default {
    ...
    data(){
      return {
          ...
          adList: [
            {image: 'https://i.postimg.cc/2y5rnM6w/circle-ad-1.png'},
            {image: 'https://i.postimg.cc/Y2QsxbgN/circle-ad-2.png'},
            {image: 'https://i.postimg.cc/HLX7ccc2/circle-ad-3.png'}
          ],
          adAutoplay: false,
